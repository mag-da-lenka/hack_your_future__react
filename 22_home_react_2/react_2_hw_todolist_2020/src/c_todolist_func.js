...
class TaskListFunc extends React.Component {

    state = {
        tasks: [
            { "nr": 10, "description": 'Sing with the cat', "date": myDateFormat_month_number1, completed: false },
            { "nr": 20, "description": 'Code for squirrels', "date": myDateFormat_month_number2, completed: false },
            { "nr": 30, "description": 'Comb the tail', "date": myDateFormat_month_number3, completed: false },
            { "nr": 40, "description": 'Listen to Sepultura', "date": myDateFormat_month_number4, completed: false },
            { "nr": 50, "description": 'Swim, bike and hike', "date": myDateFormat_month_number4, completed: false },
            { "nr": 60, "description": 'Celebrate being 50', "date": myDateFormat_month_number4, completed: false },
            { "nr": 70, "description": 'Have a pizza and nuts', "date": myDateFormat_month_number4, completed: false }
        ]
    };
        ...
        return (
            ...
            <div>
                ...
                <div className="add_item_btn_div" >
                    <h2 className="list-top"> add random tasks  </h2>
